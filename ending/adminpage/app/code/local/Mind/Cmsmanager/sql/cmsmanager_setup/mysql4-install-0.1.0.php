...
-- DROP TABLE IF EXISTS {$this->getTable('cmsmanager')};
CREATE TABLE {$this->getTable('cmsmanager')} (
  `cmsmanager_id` int(11) unsigned NOT NULL auto_increment,
