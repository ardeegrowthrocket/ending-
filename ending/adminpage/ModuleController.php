...
class <Namespace>_<Module>_Adminhtml_<Module>Controller extends Mage_Adminhtml_Controller_action
{
	...
	public function editAction() {
		...
		if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
				try {	
					...
					chmod($path.$_FILES['image']['name'],0755);
    ...
    public function exportCsvAction()
    {
        ...
        $this->_sendUploadResponse($image, $content);
    }
    ...
    protected function _sendUploadResponse($image, $content, $contentType='application/octet-stream')
    {
